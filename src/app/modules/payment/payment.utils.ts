...
export const initialPayment = async (paymentData: any) => {
    try {
        const response = await axios.post(config.payment_url!, {
            ...
            success_url: `http://gardening-project-backend.vercel.app/api/payment/confirmation?transactionId=${paymentData.transactionId}&status=success&id=${paymentData.user}`,
